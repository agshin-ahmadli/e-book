...
public class BookController {
    ...
    @GetMapping("/borrowed")
    public ResponseEntity<PageResponse<BorrowedResponse>> findAllBorrowedBooks(
            @RequestParam(name = "page", defaultValue = "0", required = false) int page,
            @RequestParam(name = "size", defaultValue = "10", required = false) int size,
            Authentication connectedUser
    ){
    ...
    @GetMapping("/returned")
    public ResponseEntity<PageResponse<BorrowedResponse>> findAllReturnedBooks(
            @RequestParam(name = "page", defaultValue = "0", required = false) int page,
            @RequestParam(name = "size", defaultValue = "10", required = false) int size,
            Authentication connectedUser
    ){
    ...
    public ResponseEntity<Integer> updateUpdateArchiveStatus(
            @PathVariable("book-id") Integer bookId,
            Authentication connectedUser
    ){
        return ResponseEntity.ok(service.updateUpdateArchiveStatus(bookId,connectedUser));
    }
    ...
    @PatchMapping("/borrow/ruturn/{book-id}")
